if light_size < 8 { light_size = lerp(light_size, 8, 0.05); }
        ...
        if active == true {
            ...
            if selected {
                ...
                if been_selected == false {
                    ...
                    ds_list_add(global.selected_infantry_list, id);
                }
                ...
                if global.reticule_display == true {
                    ...
                    if been_selected == true {
                        ...
                        ds_list_delete(global.selected_infantry_list, ds_list_find_index(global.selected_infantry_list, id));
