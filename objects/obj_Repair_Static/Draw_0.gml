if build_pos == 2 {
    if global.my_turn == true || global.waiting == true {
        if selected {
            ...
            draw_sprite_ext(spr_Repair_00, 0, x, y, 1, 1, rot, c_white, 1);
            draw_sprite_ext(spr_Repair_01, 0, x, y, 1, 1, rot, c_white, 1);
            draw_sprite_ext(spr_Repair_02, 0, x, y, 1, 1, rot, c_white, 1);  
            if global.nav_select == true {
                ...
                draw_sprite_ext(my_inf, 0, x_end, y_end, 0.75, 0.75, 0, c_white, 0.5);
            }
    ...
    draw_sprite_ext(spr_Repair_00, 0, x, y, 1, 1, rot, c_white, 1);
    draw_sprite_ext(spr_Repair_01, 0, x, y, 1, 1, rot, c_white, 1);
    draw_sprite_ext(spr_Repair_02, 0, x, y, 1, 1, rot, c_white, 0.4);
 }
    else if build_pos == 0 {
        if global.vis_mask == true { draw_sprite_ext(spr_Octagon_Gray, 0, x, y, 1, 1, 0, c_white, 1); }
        draw_sprite_ext(spr_Repair_00, 0, x, y, 1, 1, rot, c_white, 1);
        draw_sprite_ext(spr_Repair_01, 0, x, y, 1, 1, rot, c_white, 0.4);
    }
	
draw_set_halign(fa_center);
if is_occupied == false { scr_DrawSquad(my_squad); }
