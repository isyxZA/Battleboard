        ...
        if active == true {
            ...
            if selected {
                ...
                if been_selected == false {
                    ...
                    ds_list_add(global.selected_lava_list, id);
                }
                ...
                if global.reticule_display == true {
                                ...
                                //If unit has a clear line of sight
                                    ...
                                    if d <= action_range {
                                        ...
                                        if (global.turn_AP >= ap_cost) && (action_points >= 2) {
                                            ...
                                            if (he_ammo >= he_rate) || (ap_ammo >= ap_rate) || (mg_ammo >= mg_rate) || (tow_ammo >= tow_rate) || (sqd_ammo >= sqd_rate) {
                                                can_shoot = true; 
                                            }
                    ...
                    if been_selected == true {
                        ...
                        ds_list_delete(global.selected_lava_list, ds_list_find_index(global.selected_lava_list, id));
