...
if p_side == "ONE" { 
	...
	switch p_faction {
		case "US":
			...
			my_armor  = spr_Engineer_A1_Armor;
		...
		case "RU":
			...
			my_armor  = spr_Engineer_B1_Armor;
		...
		switch p_faction {
			case "US":
				...
				my_armor  = spr_Engineer_A2_Armor;
			...
			case "RU":
				...
				my_armor  = spr_Engineer_B2_Armor;
...
ds_list_add(global.laca_list, id);
