...
part_system_destroy(particle_tow0);
part_system_destroy(particle_tow1);
obj_CONTROL.lost_tow += 1;
switch my_squad {
    case "ALPHA":
...
ds_list_delete(global.tow_list, ds_list_find_index(global.tow_list, id));//Remove self from unit list
path_delete(my_path);
