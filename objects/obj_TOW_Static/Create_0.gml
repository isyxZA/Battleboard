...
ds_list_add(global.tow_list, id);
...
part_system_depth(particle_tow0, -5);
part_system_depth(particle_tow1, -7);
tow0_emitter = part_emitter_create(particle_tow0);
tow1_emitter = part_emitter_create(particle_tow1);
