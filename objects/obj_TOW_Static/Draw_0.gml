if build_pos == 2 {
    if global.my_turn == true || global.waiting == true {
        if selected {
            ...
            draw_sprite_ext(spr_TOW_00, 0, x, y, 1, 1, rot, c_white, 1);
            draw_sprite_ext(spr_TOW_01, 0, x, y, 1, 1, rot, c_white, 1);
            draw_sprite_ext(spr_TOW_02, 0, x, y, 1, 1, turret_rot, c_white, 1);  
    ...
    draw_sprite_ext(spr_TOW_00, 0, x, y, 1, 1, rot, c_white, 1);
    draw_sprite_ext(spr_TOW_01, 0, x, y, 1, 1, rot, c_white, 1);
    draw_sprite_ext(spr_TOW_02, 0, x, y, 1, 1, rot, c_white, 0.4);
 }
    else if build_pos == 0 {
        if global.vis_mask == true { draw_sprite_ext(spr_Octagon_Gray, 0, x, y, 1, 1, 0, c_white, 1); }
        draw_sprite_ext(spr_TOW_00, 0, x, y, 1, 1, rot, c_white, 1);
        draw_sprite_ext(spr_TOW_01, 0, x, y, 1, 1, rot, c_white, 0.4);
    }
