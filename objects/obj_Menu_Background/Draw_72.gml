switch room {
    case rm_MainMenu:
	    ...
	    shader_set_uniform_f(uni_settings, 2, 1, 0.4, 1); //vignette inner circle size, vignette outter circle size, noise strength, noise enable (1 or 0 only).
    ...
    case rm_Pause:
		shader_set(shd_vignette_noise);
	    shader_set_uniform_f(uni_settings, 2, 1, 0.5, 1); //vignette inner circle size, vignette outter circle size, noise strength, noise enable (1 or 0 only).
	...
	case rm_Host:
		...
		draw_sprite_ext(spr_Menu_Button, 0, room_width*0.5, 64               , 0.7, 0.7, 0, c_white, 1);
		draw_sprite_ext(spr_Menu_Button, 0, room_width*0.5, room_height*0.175, 0.7, 0.7, 0, c_white, 1);
        draw_sprite_ext(spr_Menu_Button, 0, room_width*0.5, room_height*0.43 , 0.7, 0.7, 0, c_white, 1);
    ...
    case rm_Options:
        ...
        draw_sprite_ext(spr_Menu_Button, 0, room_width*0.5, 96, 0.7, 0.7, 0, c_white, 1);
        draw_sprite_ext(spr_Menu_Button, 0, 292           , 96, 0.7, 0.7, 0, c_white, 1);
        draw_sprite_ext(spr_Menu_Button, 0, 1628          , 96, 0.7, 0.7, 0, c_white, 1);
        draw_set_valign(fa_middle);
        draw_set_halign(fa_center);
        draw_set_font(fnt_16);
    ...
    case rm_Setup:
        ...
        draw_set_halign(fa_center);
        draw_set_font(fnt_16);
        draw_sprite_ext(spr_Menu_Button, 0, x, y-400, 0.8, 0.7, 0, c_white, 1);
        draw_text_colour_shadow(x, y-400, "Game Setup", c1, c1, c1, c1, 1, 330, c_black, 0.7);
		draw_sprite_ext(spr_Menu_Button, 0, x, y-300, 0.8, 0.7, 0, c_white, 1);
        draw_text_colour_shadow(x, y-300, "Position", c1, c1, c1, c1, 1, 330, c_black, 0.7);
        draw_sprite_ext(spr_Menu_Button, 0, x, y-50, 0.8, 0.7, 0, c_white, 1);
        draw_text_colour_shadow(x, y-50, "Turn Timer", c1, c1, c1, c1, 1, 330, c_black, 0.7);
        draw_sprite_ext(spr_Menu_Button, 0, x, y+200, 0.8, 0.7, 0, c_white, 1);
		...
		draw_sprite_ext(spr_Menu_Button, 0, x+630, y-400, 0.8, 0.7, 0, c_white, 1);
        draw_text_colour_shadow(x+630, y-400, "Unit Setup", c1, c1, c1, c1, 1, 330, c_black, 0.7);
		draw_sprite_ext(spr_Menu_Button, 0, x+630, y-244, 0.8, 0.7, 0, c_white, 1);
        draw_text_colour_shadow(x+630, y-244, "Your Faction", c1, c1, c1, c1, 1, 330, c_black, 0.7);
        draw_sprite_ext(spr_Menu_Button, 0, x+630, y+64, 0.8, 0.7, 0, c_white, 1);
        ...
        draw_sprite_ext(spr_Menu_Button, 0, x+1300, y-400, 0.8, 0.7, 0, c_white, 1);
