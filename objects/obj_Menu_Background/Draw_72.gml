switch room {
    ...
    case rm_Pause:
        ...
        draw_set_alpha(0.7);
        draw_roundrect_colour_ext(x+70, y, x+438, y+828, 4, 4, c_black, c_black, false);
        draw_set_alpha(1);
        break;
	case rm_Join:
		shader_set(shd_vignette_noise);
    ...
    case rm_Setup:
        ...
        draw_set_halign(fa_center);
        draw_set_font(fnt_16);
        draw_sprite_ext(spr_Menu_Button, 0, x, y-400, 0.9, 0.8, 0, c_white, 1);
        draw_text_colour_shadow(x, y-400, "Game Setup", c1, c1, c1, c1, 1, 330, c_black, 0.7);
		draw_sprite_ext(spr_Menu_Button, 0, x, y-300, 0.9, 0.8, 0, c_white, 1);
        draw_text_colour_shadow(x, y-300, "Position", c1, c1, c1, c1, 1, 330, c_black, 0.7);
        draw_sprite_ext(spr_Menu_Button, 0, x, y-50, 0.9, 0.8, 0, c_white, 1);
        draw_text_colour_shadow(x, y-50, "Turn Timer", c1, c1, c1, c1, 1, 330, c_black, 0.7);
        draw_sprite_ext(spr_Menu_Button, 0, x, y+200, 0.9, 0.8, 0, c_white, 1);
		...
		draw_sprite_ext(spr_Menu_Button, 0, x+630, y-400, 0.9, 0.8, 0, c_white, 1);
        draw_text_colour_shadow(x+630, y-400, "Unit Setup", c1, c1, c1, c1, 1, 330, c_black, 0.7);
		draw_sprite_ext(spr_Menu_Button, 0, x+630, y-244, 0.9, 0.8, 0, c_white, 1);
        draw_text_colour_shadow(x+630, y-244, "Your Faction", c1, c1, c1, c1, 1, 330, c_black, 0.7);
        draw_sprite_ext(spr_Menu_Button, 0, x+630, y+64, 0.9, 0.8, 0, c_white, 1);
        ...
        draw_sprite_ext(spr_Menu_Button, 0, x+1300, y-400, 0.9, 0.8, 0, c_white, 1);
