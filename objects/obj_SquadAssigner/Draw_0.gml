...
draw_text_colour_shadow(x, y+212, string(my_squad), c_white, t_colour, t_colour, t_colour, 1, 300, c_black, 0.6);
draw_set_font(fnt_12);
    
if (auto_assign == false) && (active == true) { draw_sprite_ext(sprite_index, 0, x, y, 1.1, 1.1, 0, c_white, 1); }
