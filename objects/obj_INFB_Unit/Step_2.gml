if nav_confirmed == true {
    ...
    if can_move == true {
        ...
        //Add alert to gui
        ds_list_add(global.action_alert_list, "Recon Moving");
    }
...
if action_confirmed == true {
    ...
    if shoot_rifle == true { 
        if !shoot_mask.t_line {
            //Add alert to gui
            ds_list_add(global.action_alert_list, "Recon Firing Rifles");
            shoot_rifle = false;
            timer_target = 3;
            ...
            if !shoot_mask.t_line {
                ...
                //Add alert to gui
                ds_list_add(global.action_alert_list, "Recon Firing Flare");
                shoot_flare = false;
                timer_target = 3;
                timer_count = timer_target;
                timer_start = true;
