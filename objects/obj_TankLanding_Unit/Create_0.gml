...
if PLAYER.player == "ONE" { 
	...
	switch p_faction {
		case "US":
			u_spriteA = spr_Tank_A1_Icon;
			u_spriteB = spr_Tank_A1a_Icon;
			break;
		case "RU":
			u_spriteA = spr_Tank_B1_Icon;
			u_spriteB = spr_Tank_B1a_Icon;
			break;
	}
}
		...
		switch p_faction {
			case "US":
				u_spriteA = spr_Tank_A2_Icon;
				u_spriteB = spr_Tank_A2a_Icon;
				break;
			case "RU":
				u_spriteA = spr_Tank_B2_Icon;
				u_spriteB = spr_Tank_B2a_Icon;
				break;
		} 
	}
...
var i;
for (i=0; i<ds_list_size(global.temp_tank); i+=1) {
	var v = ds_list_find_value(global.temp_tank, i);
	switch v {
		case "MBT_A":
