if light_size < 6 { light_size = lerp(light_size, 6, 0.05); }
        ...
        if active == true {
            ...
            if selected {
                ...
                if been_selected == false {
                    ...
                    ds_list_add(global.selected_engineer_list, id);
                }
                ...
                if global.reticule_display == true {
                    ...
                    if been_selected == true {
                        ...
                        ds_list_delete(global.selected_engineer_list, ds_list_find_index(global.selected_engineer_list, id));
