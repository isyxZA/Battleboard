if light_size < 4 { light_size = lerp(light_size, 4, 0.01); }
            ...
            if (is_manned == true) && (can_be_selected == true) {
                ...
                if selected {
                    ...
                    if been_selected == false {
                        ...
                        ds_list_add(global.selected_mortar_list, id);
                    }
                    ...
                    if global.reticule_display == true {
                        ...
                        var fov = point_direction(x_end, y_end, global.target_x, global.target_y);
                        ...
                        else { if can_shoot == true { can_shoot = false; } }
                }
                    else {
                        ...
                        if been_selected == true {
                            ...
                            ds_list_delete(global.selected_mortar_list, ds_list_find_index(global.selected_mortar_list, id));
