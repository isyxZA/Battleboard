if surface_exists (fow_surf) {
    ...
    with(obj_Bullet_Parent) {
		if explode == true {
            draw_sprite_ext(spr_LightPoint01,0, x*fow1_scale, y*fow1_scale, light_size*fow1_scale, light_size*fow1_scale, 0, c_white, light_strength);
				...
				if can_draw == true { draw_sprite_ext(sprite_index,0, x*fow1_scale, y*fow1_scale, 1*fow1_scale, 1*fow1_scale, rot, c_white, 1); }
			}
    }
	...
	draw_sprite_tiled_ext(spr_Fog_Upper, 0, fx2, fy2, fw2, fh2, c_black, aa2);
