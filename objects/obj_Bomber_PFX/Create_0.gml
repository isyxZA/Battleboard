...
part_system_depth(particle_bomber0, -12);
...
part_type_alpha3(part3, 0.3, 1, 0.3);
part_type_speed(part3, 1.5, 2.5, -0.0725, 0);
...
part_type_life(part6, 400, 500);

part_type_death(part1, 8, part5);
