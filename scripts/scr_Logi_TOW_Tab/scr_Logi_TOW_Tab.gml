/// @description scr_Logi_TOW_Tab(target_unit, tow_ammo, tow_max, tow_rate);
/// @param target_unit
/// @param  tow_ammo
/// @param  tow_max
/// @param  tow_rate
function scr_Logi_TOW_Tab(argument0, argument1, argument2, argument3) {
	...
	if f0 {
	    ...
	    obj_ACTIONMENU.display_menuinfo = false;
	        ...
	        if mouse_wheel_up() { 
	            ...
	            if global.towS_l_amount <= (global.ammo_supply-towS_supply_rate) {
	                //Make sure the unit ammo does not go over max
	                if ((global.towS_l_amount+towS_count)+towS_supply_rate) <= tow_max {
	                    ...
	                    if m_ap >=  ap_cost {
	                        ...
	                        if ap >= ((global.towS_l_amount+towS_supply_rate)/towS_supply_rate)*ap_cost {
	                            //Add the rounds
	                            global.towS_l_amount +=  towS_supply_rate; 
	                        }
	                    }
	                }
	            } 
	        ...
	        if mouse_wheel_down() { 
	            if global.towS_l_amount >= towS_supply_rate { 
	                global.towS_l_amount -= towS_supply_rate; 
	            } 
	        }
	        //Clamp the value between zero and the max available rounds
	        if global.towS_l_amount < 0 { global.towS_l_amount = 0; }
	        if global.towS_l_amount > global.ammo_supply { global.towS_l_amount = global.ammo_supply; }
	        //Add to temp AP cost
	        global.temp_AP = (global.towS_l_amount/towS_supply_rate)*ap_cost;
	    ...
	    if global.my_turn == true {
	        if f0 { 
	            ...
	            if global.selected_depot != 0 {
	                ...
	                //TRANSFER TOW AMMO
	                //Remove ammo cost
	                if global.towS_l_amount != 0 {
	                    var t=0;
	                    while (global.towS_l_amount >= towS_supply_rate) {
	                        t+=1;
	                        var i;
	                        for (i=0; i<ds_list_size(global.selected_logi_list); i+=1) {
