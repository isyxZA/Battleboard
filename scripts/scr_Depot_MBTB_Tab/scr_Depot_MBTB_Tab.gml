/// @description scr_Depot_MBTB_Tab(target_unit, cannon_ammo, mg_ammo, cannon_max, mg_max, cannon_rate, mg_rate);
/// @param target_unit
/// @param  cannon_ammo
/// @param  mg_ammo
/// @param  cannon_max
...
/// @param  cannon_rate
/// @param  mg_rate
function scr_Depot_MBTB_Tab(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
