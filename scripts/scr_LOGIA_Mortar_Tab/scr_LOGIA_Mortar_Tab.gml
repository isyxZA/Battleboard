/// @description scr_LOGIA_Mortar_Tab(target_unit, mortar_ammo, mortar_max, mortar_rate);
/// @param target_unit
/// @param mortar_ammo
/// @param mortar_max
/// @param mortar_rate
function scr_LOGIA_Mortar_Tab(argument0, argument1, argument2, argument3) {
	...
	if f0 {
	    ...
	    obj_ACTIONMENU.display_menuinfo = false;
	        ...
	        if mouse_wheel_up() { 
	            ...
	            if mtramo_l_amount <= (logia_amo_supply-mortarS_supply_rate) {
	        ...
	        if mtramo_l_amount > logia_amo_supply { mtramo_l_amount = logia_amo_supply; }
	        //Add to temp AP cost
