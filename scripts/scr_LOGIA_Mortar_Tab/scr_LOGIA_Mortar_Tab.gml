	...
	*/
	...
	if f0 {
	    ...
	    obj_ACTIONMENU.display_menuinfo = false;
	            ...
	            if global.mtramo_l_amount <= (global.ammo_supply-mortarS_supply_rate) {
	                ...
	                if ((global.mtramo_l_amount+mortarS_count)+mortarS_supply_rate) <= mortar_max {
	                    ...
	                    if m_ap >=  ap_cost {
	                        ...
	                        if ap >= ((global.mtramo_l_amount+mortarS_supply_rate)/mortarS_supply_rate)*ap_cost {
	                            //Add the rounds
	                            global.mtramo_l_amount += mortarS_supply_rate; 
	                        }
	                    }
	                }
	            } 
	        ...
	        if mouse_wheel_down() { 
	            if global.mtramo_l_amount >= mortarS_supply_rate { 
	                global.mtramo_l_amount -= mortarS_supply_rate; 
	            } 
	        }
	    ...
	    if global.my_turn == true {
	        if f0 { 
				...
				if global.selected_logib != 0 {
	                ...
	                //Remove ammo cost
	                if global.mtramo_l_amount != 0 {
	                    var t=0;
	                    while (global.mtramo_l_amount >= mortarS_supply_rate) {
	                        t+=1;
	                        var i;
	                        for (i=0; i<ds_list_size(global.selected_logia_list); i+=1) {
