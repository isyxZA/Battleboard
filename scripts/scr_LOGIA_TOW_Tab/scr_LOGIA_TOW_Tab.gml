/// @description scr_LOGIA_TOW_Tab(target_unit, tow_ammo, tow_max, tow_rate);
/// @param target_unit
/// @param tow_ammo
/// @param tow_max
/// @param tow_rate
function scr_LOGIA_TOW_Tab(argument0, argument1, argument2, argument3) {
	...
	*/
	...
	if f0 {
	    ...
	    obj_ACTIONMENU.display_menuinfo = false;
	            ...
	            if global.towamo_l_amount <= (global.ammo_supply-towS_supply_rate) {
	                ...
	                if ((global.towamo_l_amount+towS_count)+towS_supply_rate) <= tow_max {
	                    ...
	                    if m_ap >=  ap_cost {
	                        ...
	                        if ap >= ((global.towamo_l_amount+towS_supply_rate)/towS_supply_rate)*ap_cost {
	                            //Add the rounds
	                            global.towamo_l_amount +=  towS_supply_rate; 
	                        }
	                    }
	                }
	            } 
	        ...
	        if mouse_wheel_down() { 
	            if global.towamo_l_amount >= towS_supply_rate { 
	                global.towamo_l_amount -= towS_supply_rate; 
	            } 
	        }
	    ...
	    if global.my_turn == true {
	        if f0 { 
				...
				if global.selected_logib != 0 {
	                ...
	                //TRANSFER TOW AMMO
	                //Remove ammo cost
	                if global.towamo_l_amount != 0 {
	                    var t=0;
	                    while (global.towamo_l_amount >= towS_supply_rate) {
	                        t+=1;
	                        var i;
	                        for (i=0; i<ds_list_size(global.selected_logia_list); i+=1) {
