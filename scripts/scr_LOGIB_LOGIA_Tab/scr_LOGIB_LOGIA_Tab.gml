/// @description scr_LOGIB_LOGIA_Tab(target_unit, ammo_supply, ammo_max, ammo_rate);
/// @param target_unit
/// @param ammo_supply
/// @param ammo_max
/// @param ammo_rate
function scr_LOGIB_LOGIA_Tab(argument0, argument1, argument2, argument3) {

	/*
	lala_fire_menu[0] = "Ammunition";
	lala_fire_menu[1] = "Retarget";
	lala_fire_menu[2] = "Cancel";
	*/
