...
function scr_DrawShipStats() {
	with obj_LogiLanding_Unit {
	    if selected {
			...
			if depleted == true {
	            ...
	            draw_sprite_ext(spr_Building_Icon,     0, xx1, y, 1, 1, 0, c_white, 1);
	            ...
	            draw_sprite_ext(spr_Ammo_Icon, 0, xx4, y, 1, 1, 0, c_white, 1);
	...
	with obj_SoldierLanding_Unit {
	     if selected {
	        ...
	        draw_set_halign(fa_center);
	        draw_set_valign(fa_middle);
	        draw_text_transformed_colour(x, yy, "LANDING CRAFT", 1, 1, txt_rot, c_white, c_white, c_white, c_white, 1);
	        draw_set_font(fnt_10);
	     }
	}
