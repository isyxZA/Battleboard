	...
	if f0 {
	    ...
	    obj_ACTIONMENU.display_menuinfo = false;
	        ...
	        if mouse_wheel_up() { 
	            ...
	            if global.towamo_d_amount <= (global.dpt_amo_supply-towS_supply_rate) {
	        ...
	        if global.towamo_d_amount > global.dpt_amo_supply { global.towamo_d_amount = global.dpt_amo_supply; }
	        //Add to temp AP cost
