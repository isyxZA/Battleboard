...
function scr_Draw_Sprite_Path(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10, argument11) {

	/// @param path = path index
	/// @param x = offset x
	/// @param y = offset y
	/// @param width = thickness of the path
	/// @param sprite = sprite to use
	/// @param spriteIndex = image index of the given sprite
	/// @param spriteScaleX = x scale for the sprite
	/// @param priteScaleY = y scale for the sprite
