/// @description scr_Depot_LAVB_Tab(target_unit, he_ammo, ap_ammo, mg_ammo, he_max, ap_max, mg_max, he_rate, ap_rate, mg_rate);
/// @param target_unit
/// @param he_ammo
/// @param ap_ammo
/// @param mg_ammo
...
/// @param ap_rate
/// @param mg_rate
function scr_Depot_LAVB_Tab(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
	    ...
	    obj_ACTIONMENU.display_menuinfo = false;
	        ...
	        obj_ACTIONMENU.display_menuinfo = true;
	            ...
	            obj_ACTIONMENU.display_menuinfo = true;
		            ...
		            if mouse_wheel_up() { 
		                //Check if there is enough ammo available
		                if global.lavmg_l_amount <= (global.dpt_amo_supply-lavmg_supply_rate) { 
		                    //Make sure the unit rpg ammo does not go over max
		            ...
		            if global.lavmg_l_amount > global.dpt_amo_supply { global.lavmg_l_amount = global.dpt_amo_supply; }
		            //Add to temp AP cost
