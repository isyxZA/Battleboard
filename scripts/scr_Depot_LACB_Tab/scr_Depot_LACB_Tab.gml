	...
	if f0 {
	    ...
	    obj_ACTIONMENU.display_menuinfo = false;
	        ...
	        if mouse_wheel_up() { 
	            ...
	            if global.lactow2_d_amount <= (global.dpt_amo_supply-lactow2_supply_rate) {
	                //Make sure the unit does not go over max
	                if ((global.lactow2_d_amount+tow_count)+lactow2_supply_rate) <= tow_max {
	                    ...
	                    if m_ap >= ap_cost {
	                        ...
	                        if ap >= ((global.lactow2_d_amount+lactow2_supply_rate)/lactow2_supply_rate)*ap_cost {
	                            //Add the rounds
	                            global.lactow2_d_amount += lactow2_supply_rate; 
	                        }
	                    }
	                }
	            } 
	        ...
	        if mouse_wheel_down() { 
	            if global.lactow2_d_amount >= lactow2_supply_rate { 
	                global.lactow2_d_amount -= lactow2_supply_rate; 
	            } 
	        }
	        //Clamp the value between zero and the max available rounds
	        if global.lactow2_d_amount < 0 { global.lactow2_d_amount = 0; }
	        if global.lactow2_d_amount > global.dpt_amo_supply { global.lactow2_d_amount = global.dpt_amo_supply; }
	        //Add to temp AP cost
	        global.temp_AP = (global.lactow2_d_amount/lactow2_supply_rate)*ap_cost;
	    ...
	    if global.my_turn == true {
	        if f0 { 
	            ...
	            if global.selected_repair != 0 {
	                ...
	                //TRANSFER TOW AMMO
	                //Remove supply cost
	                if global.lactow2_d_amount != 0 {
	                    var t=0;
	                    while (global.lactow2_d_amount >= lacdpt_supply_rate) {
	                        t+=1;
	                        var i;
	                        for (i=0; i<ds_list_size(global.selected_depot_list); i+=1) {
