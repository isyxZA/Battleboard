/// @description draw_text_ext_transformed_shadow(x, y, string, sep, w, xscale, yscale, angle, shadow length, shadow direction, shadow color, shadow alpha);
/// @param x
/// @param  y
/// @param  string
/// @param  sep
...
/// @param  shadow color
/// @param  shadow alpha
function draw_text_ext_transformed_shadow(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10, argument11) {
	//@tehwave
