/// @description scr_LOGIB_LACB_Tab(target_unit, tow_ammo, tow_max, tow_rate);
/// @param target_unit
/// @param  tow_ammo
/// @param  tow_max
/// @param  tow_rate
function scr_LOGIB_LACB_Tab(argument0, argument1, argument2, argument3) {
	    ...
	    obj_ACTIONMENU.display_menuinfo = false;
	        ...
	        if mouse_wheel_up() { 
	            ...
	            if lactow2_l_amount <= (logib_amo_supply-lactow2_supply_rate) {
	                ...
	                if ((lactow2_l_amount+tow_count)+lactow2_supply_rate) <= tow_max {
	                    ...
	                    if m_ap >= ap_cost {
	                        ...
	                        if ap >= ((lactow2_l_amount+lactow2_supply_rate)/lactow2_supply_rate)*ap_cost {
	                            //Add the rounds
	        ...
	        if lactow2_l_amount < 0 { lactow2_l_amount = 0; }
	        if lactow2_l_amount > logib_amo_supply { lactow2_l_amount = logib_amo_supply; }
	        //Add to temp AP cost
	        global.temp_AP = (lactow2_l_amount/lactow2_supply_rate)*ap_cost;
