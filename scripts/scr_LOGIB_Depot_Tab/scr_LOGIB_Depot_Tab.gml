/// @description scr_LOGIB_Depot_Tab(target_unit, ammunition_ammo, ammunition_max, ammunition_rate);
/// @param target_unit
/// @param  ammunition_ammo
/// @param  ammunition_max
/// @param  ammunition_rate
function scr_LOGIB_Depot_Tab(argument0, argument1, argument2, argument3) {

	/*
	lbd_fire_menu[0] = "Ammunition";
	lbd_fire_menu[1] = "Retarget";
	lbd_fire_menu[2] = "Cancel";
	*/

	var depotammo_count       = argument1;
	var ammunition_max        = argument2;
	var depotamo_supply_rate  = argument3;
	...
	if f0 {
	    ...
	    obj_ACTIONMENU.display_menuinfo = false;
		    ...
		    if mouse_wheel_up() { 
		        ...
		        if dptamo_l_amount <= (logib_amo_supply-depotamo_supply_rate) {
		    ...
		    if dptamo_l_amount > logib_amo_supply { dptamo_l_amount = logib_amo_supply; }
		    //Add to temp AP cost
