/// @description scr_SupplyShip_Logi_Tab(target_unit, ammo_supply, building_supply, ammo_max, building_max, ammo_rate, building_rate);
/// @param  target_unit
/// @param  ammo_supply
...
/// @param  ammo_rate
/// @param  building_rate
function scr_SupplyShip_Logi_Tab(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
