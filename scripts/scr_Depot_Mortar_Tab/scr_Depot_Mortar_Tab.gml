/// @description scr_Depot_Mortar_Tab(target_unit, mortar_ammo, mortar_max, mortar_rate);
/// @param target_unit
/// @param  mortar_ammo
/// @param  mortar_max
/// @param  mortar_rate
function scr_Depot_Mortar_Tab(argument0, argument1, argument2, argument3) {

	/*  Arguments
	0   resupply unit ID        
	1   mortar ammo count     
	2   max mortar ammo capacity              
	*/

	/*
	lm_fire_menu[0] = "Mortar Ammo";
	lm_fire_menu[1] = "Retarget";
	lm_fire_menu[2] = "Cancel";
	*/

	var mortarS_count       = argument1;
	var mortar_max          = argument2;
	var mortarS_supply_rate = argument3;
	...
	if f0 {
	    ...
	    obj_ACTIONMENU.display_menuinfo = false;
	        ...
	        if mouse_wheel_up() { 
	            ...
	            if global.mortarS_d_amount <= (global.ammunition_ammo-mortarS_supply_rate) {
	                //Make sure the unit ammo does not go over max
	                if ((global.mortarS_d_amount+mortarS_count)+mortarS_supply_rate) <= mortar_max {
	                    ...
	                    if m_ap >=  ap_cost {
	                        ...
	                        if ap >= ((global.mortarS_d_amount+mortarS_supply_rate)/mortarS_supply_rate)*ap_cost {
	                            //Add the rounds
	                            global.mortarS_d_amount += mortarS_supply_rate; 
	                        }
	                    }
	                }
	            } 
	        ...
	        if mouse_wheel_down() { 
	            if global.mortarS_d_amount >= mortarS_supply_rate { 
	                global.mortarS_d_amount -= mortarS_supply_rate; 
	            } 
	        }
	        //Clamp the value between zero and the max available rounds
	        if global.mortarS_d_amount < 0 { global.mortarS_d_amount = 0; }
	        if global.mortarS_d_amount > global.ammunition_ammo { global.mortarS_d_amount = global.ammunition_ammo; }
	        //Add to temp AP cost
	        global.temp_AP = (global.mortarS_d_amount/mortarS_supply_rate)*ap_cost;
	    ...
	    if global.my_turn == true {
	        if f0 { 
	            ...
	            if global.selected_depot != 0 {
	                ...
	                //Remove ammo cost
	                if global.mortarS_d_amount != 0 {
	                    var t=0;
	                    while (global.mortarS_d_amount >= mortarS_supply_rate) {
	                        t+=1;
	                        var i;
	                        for (i=0; i<ds_list_size(global.selected_depot_list); i+=1) {
	                            var u = ds_list_find_value(global.selected_depot_list, i);
	                            if (u.can_shoot == true) && (u.ammunition_ammo >= mortarS_supply_rate) {
	                                if (u.action_points >= ap_cost) {
	                                    ...
	                                    if global.mortarS_d_amount >= 0 { 
	                                        ...
	                                        u.shoot_amount    += 1; 
	                                        u.ammunition_ammo -= mortarS_supply_rate;
