/// @description scr_LOGIB_LAVA_Tab(target_unit, he_ammo, ap_ammo, mg_ammo, at_ammo, he_max, ap_max, mg_max, at_max, he_rate, ap_rate, mg_rate, at_rate);
/// @param target_unit
/// @param  he_ammo
/// @param  ap_ammo
/// @param  mg_ammo
...
/// @param  mg_rate
/// @param  at_rate
function scr_LOGIB_LAVA_Tab(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10, argument11, argument12) {
