	...
	if f0 {
	    ...
	    obj_ACTIONMENU.display_menuinfo = false;
	        ...
	        if mouse_wheel_up() { 
	            ...
	            if global.logiamo_d_amount <= (global.ammunition_ammo-logiamo_supply_rate) {
	        ...
	        if global.logiamo_d_amount > global.ammunition_ammo { global.logiamo_d_amount = global.ammunition_ammo; }
	        //Add to temp AP cost
	        ...
	        obj_ACTIONMENU.display_menuinfo = true;
	            ...
	            if mouse_wheel_up() { 
	                //Check if there is enough supply available
	                if global.logibld_d_amount <= (global.parts_ammo-logibld_supply_rate) { 
	            ...
	            if global.logibld_d_amount > global.parts_ammo { global.logibld_d_amount = global.parts_ammo; }
	            //Add to temp AP cost
