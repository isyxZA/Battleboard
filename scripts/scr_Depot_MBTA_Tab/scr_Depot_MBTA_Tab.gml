/// @description scr_Depot_MBTA_Tab(target_unit, cannon_ammo, mg_ammo, cannon_max, mg_max, cannon_rate, mg_rate);
/// @param target_unit
/// @param cannon_ammo
/// @param mg_ammo
/// @param cannon_max
...
/// @param cannon_rate
/// @param mg_rate
function scr_Depot_MBTA_Tab(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
	...
	if f0 {
	    ...
	    obj_ACTIONMENU.display_menuinfo = false;
	        ...
	        if mouse_wheel_up() { 
	            ...
	            if global.mbtap_d_amount <= (global.dpt_amo_supply-mbtap_supply_rate) {
	        ...
	        if global.mbtap_d_amount > global.dpt_amo_supply { global.mbtap_d_amount = global.dpt_amo_supply; }
	        //Add to temp AP cost
	        ...
	        obj_ACTIONMENU.display_menuinfo = true;
	            ...
	            if mouse_wheel_up() { 
	                ...
	                if global.mbtmg_d_amount <= (global.dpt_amo_supply-mbtmg_supply_rate) { 
	            ...
	            if global.mbtmg_d_amount > global.dpt_amo_supply { global.mbtmg_d_amount = global.dpt_amo_supply; }
	            //Add to temp AP cost
