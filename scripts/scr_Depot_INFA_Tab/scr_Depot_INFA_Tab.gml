	...
	if f0 {
	    ...
	    obj_ACTIONMENU.display_menuinfo = false;
	        ...
	        if mouse_wheel_up() { 
	            ...
	            if global.infrfl_d_amount <= (global.dpt_amo_supply-rfl_supply_rate) {
	        ...
	        if global.infrfl_d_amount > global.dpt_amo_supply { global.infrfl_d_amount = global.dpt_amo_supply; }
	        //Add to temp AP cost
	        ...
	        obj_ACTIONMENU.display_menuinfo = true;
	            ...
	            if mouse_wheel_up() { 
	                ...
	                if global.infrpg_d_amount <= (global.dpt_amo_supply-rpg_supply_rate) { 
	            ...
	            if global.infrpg_d_amount > global.dpt_amo_supply { global.infrpg_d_amount = global.dpt_amo_supply; }
	            //Add to temp AP cost
	            ...
	            obj_ACTIONMENU.display_menuinfo = true;
	                ...
	                if mouse_wheel_up() { 
	                    //Check if there is enough ammo available
	                    if global.infflr_d_amount <= (global.dpt_amo_supply-flr_supply_rate) { 
	                ...
	                if global.infflr_d_amount > global.dpt_amo_supply { global.infflr_d_amount = global.dpt_amo_supply; }
	                //Add to temp AP cost
