/// @description scr_Depot_INFA_Tab(target_unit, rifle_ammo, rpg_ammo, flare_ammo, rifle_max, rpg_max, flare_max, rifle_rate, rpg_rate, flare_rate);
/// @param target_unit
/// @param rifle_ammo
/// @param rpg_ammo
/// @param flare_ammo
...
/// @param rpg_rate
/// @param flare_rate
function scr_Depot_INFA_Tab(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
